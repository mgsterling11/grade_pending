...
class CuisineTypesControllerTest < ActionController::TestCase
  ...
  test "should create cuisine_type" do
    assert_difference('CuisineType.count') do
      post :create, cuisine_type: { cuisine_description: @cuisine_type.cuisine_description, restaurant_id: @cuisine_type.restaurant_id }
    end
  ...
  test "should update cuisine_type" do
    patch :update, id: @cuisine_type, cuisine_type: { cuisine_description: @cuisine_type.cuisine_description, restaurant_id: @cuisine_type.restaurant_id }
    assert_redirected_to cuisine_type_path(assigns(:cuisine_type))
  end
